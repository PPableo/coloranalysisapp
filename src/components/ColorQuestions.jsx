...
const questions = [
  ...
  {
    text:
      "Do bright and lively colors with high brightness and low saturation levels enhance your appearance?",
    category: "Spring"
  },
  {
  ...
  {
    text:
      "Do soft colors with high brightness and low saturation levels complement your look?",
    category: "Summer"
  },
  {
    text:
      "Do gentle and soothing colors make your complexion appear more vibrant?",
    category: "Summer"
  },
  ...
  {
    text:
      "Do strong colors with low brightness and high saturation levels look best on you?",
    category: "Winter"
  },
  {
...
const seasonDetails = {
  Spring: {
    description:
      "In Korean color analysis, you're a 'Bright Spring' (봄 브라이트). You look best in clear, warm, and bright colors with medium to high chroma.",
    ...
    commonColor: "#FFA500",
    contrast:
      "Korean analysis focuses more on skin undertone and brightness, recommending vivid, clear colors. Western methods might emphasize hair and eye color more, potentially suggesting a broader range of warm, clear colors."
  },
  Summer: {
    description:
      "In Korean analysis, you're a 'True Summer' (여름 트루). You suit cool, soft colors with medium brightness and low to medium chroma.",
    ...
    commonColor: "#B0C4DE",
    contrast:
      "Korean analysis emphasizes softer, more muted cool tones for Summer types. Western analysis might include a wider range of cool colors, including some brighter options, based on overall coloring rather than just skin undertone."
  },
  Autumn: {
    description:
      "Korean analysis classifies you as 'Deep Autumn' (가을 딥). You shine in warm, rich colors with low to medium brightness and medium to high chroma.",
    ...
    commonColor: "#DAA520",
    contrast:
      "Korean analysis for Autumn types tends to favor deeper, more saturated warm colors. Western methods might include a broader spectrum of warm colors, including some lighter shades, based on hair and eye color as well as skin tone."
  },
  Winter: {
    description:
      "In Korean color theory, you're a 'True Winter' (겨울 트루). You look striking in cool, clear colors with high contrast and high chroma.",
    colors: ["#000080", "#8A2BE2", "#FF0000", "#00CED1", "#FFFFFF"],
    imageContent:
      "Snow-capped mountains, clear night sky, and icy blue glaciers",
    image: "/images/korean-winter-palette.jpg",
    link: "https://www.colorme.co.kr/true-winter",
    commonColor: "#000080",
    contrast:
      "Korean Winter palettes often include very high contrast, cool-toned colors. Western analysis might suggest a mix of cool and neutral colors, potentially including more earth tones based on overall coloring."
  }
}
